...
enum InputFeasibilityResult {
  ...
  kInputIndeterminable,  ///< Cannot determine whether the trajectory is
  ...
  kInputInfeasibleVelocity,    ///< The Trajectory is infeasible, failed max.
                               ///< velocity test first.
  kInputInfeasibleRollPitchRates,  ///< The trajectory is infeasible, failed
                                   ///< max. roll/pitch rates test first.

...
Eigen::Quaterniond SquadOptimization::quaternionSum(const Eigen::Quaterniond &q1, const Eigen::Quaterniond &q2) const {
  Eigen::Quaterniond q;
  q.coeffs() = q1.coeffs() + q2.coeffs();
  return q;
}

Eigen::Quaterniond SquadOptimization::quaternionPow(const Eigen::Quaterniond &q, const double &t) const {
